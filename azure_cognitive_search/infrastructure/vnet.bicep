...
resource virtualNetwork 'Microsoft.Network/virtualNetworks@2019-11-01' = {
  ...
  resource searchSubnet 'subnets' existing = {
    name: subnetsearchName
  }
}
...
output subnetsearchId string = virtualNetwork::searchSubnet.id
